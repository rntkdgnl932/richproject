            ...
            if sRQName == "주식기본정보요청":
                ...
                if g > 0:
                    ...
                    if sCode in self.account_stock_dict.keys() and sCode not in self.jango_dict.keys():
                        ...
                        print("11111111111111", self.account_stock_dict[sCode])
                        ...
                        if int(asd['매매가능수량']) > 0:
                            ...
                            if asd['매매가능수량'] > 0:
                                ...
                                if my_first_meme == True or my_second_meme == False:

                                    if (meme_rate > self.revenue or meme_rate < -self.revenue) and sCode not in self.sell_ing:
            ...
            if str(now_time_HMS) != str(a) and delay_ > 200:
                ...
                if sCode in self.account_stock_dict.keys() and sCode not in self.jango_dict.keys():
                    ...
                    if asd['매매가능수량'] > 0:
                        ...
                        if my_first_meme == True or my_second_meme == False:
                            # my_first_meme : txt 파일에 없으면 True => 아직 1차 매도 안한 상황
                            # my_second_meme : 잔고에 있는 총 매입금액이 2차 매도기준보다 크면 True => 아직 1차 매도 안한 상황
    ...
    def GetConditionNameList(self):
        ...
        for i in range(len(self.condition_names_list)):
            ...
            if 'dia' in self.condition_names_list[i]:
                self.scan_list.append(self.condition_names_list[i])
            if 'coob' in self.condition_names_list[i]:
                self.scan_list.append(self.condition_names_list[i])
